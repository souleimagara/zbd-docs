...
- Required for the [Send Rewards API](/earn/sdk/send-rewards-api)
...
- **[Send Rewards from Server](/earn/sdk/send-rewards-api)** - Use your API key to send rewards securely