...
description: "Use your API key to send rewards securely from your backend using the Earn API (v2)."
api: "POST https://api.zbdpay.com/api/v2/rewards/limited-achievement/reward"
---
