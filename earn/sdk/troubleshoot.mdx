...
<Steps>
    ...
    <Step title="Whitelist Your Device">
        ...
        - **Contact your ZBD Customer Success Manager** — Send them your Support ID so they can whitelist your device.
...
To resolve this, contact your ZBD Customer Success Manager and provide your **Support ID** so they can whitelist it. You can find your Support ID in the console logs when the SDK initializes:
