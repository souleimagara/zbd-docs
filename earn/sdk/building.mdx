...
Make sure that the minimum API Level is set to **Android 11 API Level 30** in your settings. See [Compatibility](/earn/sdk/compatibility) for the current version requirements. 
